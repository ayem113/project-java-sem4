            ...
            <div class="header-middle">
                ...
                <div class="header-middle-inner">
                    ...
                    <div class="header-logo">
                        <a href="index.html"><img alt="Furgan"src="<c:url value='/template/web/assets/images/logo.png '/>" class="logo"></a></div>
                    <div class="header-control">
                        <div class="header-control-inner">
                            <div class="meta-dreaming">
                                <ul class="wpml-menu">
                                    <li class="menu-item furgan-dropdown block-language">
                                        <a href="#" data-furgan="furgan-dropdown">
                                            <img src="/template/web/assets/images/en.png"
                                        ...
                                        <div class="widget_shopping_cart_content">
                                            <ul class="furgan-mini-cart cart_list product_list_widget">
                                                <li class="furgan-mini-cart-item mini_cart_item">
                                                    ...
                                                    <a href="#">
                                                        <img src="/template/web/assets/images/apro134-1-600x778.jpg"
                                                ...
                                                <li class="furgan-mini-cart-item mini_cart_item">
                                                    <a href="#" class="remove remove_from_cart_button">×</a>
                                                    <a href="#">
                                                        <img src="/template/web/assets/images/apro201-1-600x778.jpg"
                                                             class="attachment-furgan_thumbnail size-furgan_thumbnail"
