...
<div class="fullwidth-template">
                ...
                <div class="slide-info">
                    <div class="container">
                        <div class="slide-inner">
                            <h1>SUMMER </h1>
                            <h5>Hot Trending</h5>
                            <h2><span>Plastic Chair </span>Collection</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide-info">
                    <div class="container">
                        <div class="slide-inner">
                            <h1>SPRING </h1>
                            <h5>New Arrivals</h5>
                            <h2><span>Salon Set</span> Collection</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="slide-info">
                    <div class="container">
                        <div class="slide-inner">
                            ...
                            <h2><span>Armchair</span> For Your Relax</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="furgan-banner style-08 left-center">
                    <div class="banner-inner">
                        <figure class="banner-thumb">
                            <img src="<c:url value='/template/web/assets/images/banner31.jpg'/>"
                        ...
                        <div class="product-inner tooltip-top tooltip-all-top">
                            ...
                            <div class="product-info">
                                ...
                                <span class="price"><del><span class="furgan-Price-amount amount"><span
                                        ...
                                        class="furgan-Price-currencySymbol">$</span>${item.price}</span></ins></span>
                    ...
                    <div class="product-item best-selling style-04 rows-space-30 col-bg-3 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-ts-6 post-23 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-lamp product_cat-sofas product_tag-hat  instock shipping-taxable purchasable product-type-variable has-default-attributes">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#">
                                    <img class="img-responsive"
                                         src="/template/web/assets/images/apro171-1-270x350.jpg"
                                         alt="Dining Table" width="270" height="350">
                                </a>
                                <div class="flash">
                                    <span class="onnew"><span class="text">New</span></span></div>
                    ...
                    <div class="product-item best-selling style-04 rows-space-30 col-bg-3 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-ts-6 post-32 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-hat product_tag-sock last instock sale featured shipping-taxable purchasable product-type-simple">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#">
                                    <img class="img-responsive"
                                         src="/template/web/assets/images/apro71-1-270x350.jpg"
                    ...
                    <div class="product-item best-selling style-04 rows-space-30 col-bg-3 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-ts-6 post-20 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_cat-specials product_tag-table product_tag-hat product_tag-sock first instock sale featured shipping-taxable purchasable product-type-simple">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#">
                                    <img class="img-responsive"
                                         src="/template/web/assets/images/apro201-1-270x350.jpg"
                            ...
                            <div class="product-info">
                                ...
                                <span class="price"><del><span class="furgan-Price-amount amount"><span
                                        class="furgan-Price-currencySymbol">$</span>150.00</span></del> <ins><span
                                        class="furgan-Price-amount amount"><span
                                        class="furgan-Price-currencySymbol">$</span>139.00</span></ins></span>
                                <div class="rating-wapper nostar">
                                    <div class="star-rating"><span style="width:0%">Rated <strong
                                            class="rating">0</strong> out of 5</span></div>
                                    <span class="review">(0)</span></div>
                    ...
                    <div class="product-item best-selling style-04 rows-space-30 col-bg-3 col-xl-3 col-lg-4 col-md-4 col-sm-6 col-ts-6 post-24 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-table product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock last instock featured shipping-taxable purchasable product-type-variable has-default-attributes">
                        <div class="product-inner tooltip-top tooltip-all-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#">
                                    <img class="img-responsive"
                                         src="/template/web/assets/images/apro161-1-270x350.jpg"
                                         alt="Moss Sofa" width="270" height="350">
                                </a>
                                <div class="flash">
                                    <span class="onnew"><span class="text">New</span></span></div>
    ...
    <div class="section-018">
        <div class="container">
            <div class="row">
                <div class="offset-sm-2 col-sm-10 offset-md-4 col-md-8 offset-xl-6 col-xl-6 offset-lg-5 col-lg-7">
                ...
                <div class="blog-list-owl owl-slick equal-container better-height"
                    ...
                    <article
                        ...
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="#" tabindex="0">
                                    <img src="/template/web/assets/images/blogpost1-370x330.jpg"
                            ...
                            <div class="post-content">
                                <div class="post-info">
                                    <div class="title-date">
                                        ...
                                        <h2 class="post-title">
                                            <a href="#" tabindex="0">Not your ordinary furniture service.</a>
                                        </h2>
                                    </div>
                                    <div class="post-meta">
                    ...
                    <article
                        ...
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="#" tabindex="0">
                                    <img src="/template/web/assets/images/blogpost5-370x330.jpg"
                    ...
                    <article
                        ...
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="#"
                                   tabindex="0">
                                    <img src="/template/web/assets/images/blogpost9-370x330.jpg"
                                         class="img-responsive attachment-370x330 size-370x330" alt="img"
                                         width="370" height="330"> </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
                                    <div class="title-date">
                                        ...
                                        <h2 class="post-title"><a
                                                href="#"
                                                tabindex="0">We design functional best furniture</a></h2>
                                    </div>
                                    <div class="post-meta">
                                        <div class="post-author">
                                            By:<a href="#" tabindex="0">
                    ...
                    <article
                        ...
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="#" tabindex="-1">
                                    <img src="/template/web/assets/images/blogpost4-370x330.jpg"
                                         class="img-responsive attachment-370x330 size-370x330" alt="img" width="370"
                                         height="330">
                                </a>
                            </div>
                    ...
                    <article
                        ...
                        <div class="post-inner">
                            <div class="post-thumb">
                                <a href="#" tabindex="-1">
                                    <img src="/template/web/assets/images/blogpost2-370x330.jpg"
                                         class="img-responsive attachment-370x330 size-370x330" alt="img"
                                         width="370" height="330"> </a>
                            </div>
                            <div class="post-content">
                                <div class="post-info">
                                    <div class="title-date">
                                        ...
                                        <h2 class="post-title"><a
                                                href="#"
                                                tabindex="-1">Furniture hiding beside beige wall</a></h2>
                                    </div>
                                    <div class="post-meta">
                                        <div class="post-author">
                                            By:<a href="#" tabindex="-1">
            ...
            <div class="instagram-owl owl-slick"
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta1.jpg" alt="Home 03">
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta2.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta3.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta4.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta5.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta6.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta7.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
                ...
                <div class="rows-space-0">
                    <a target="_blank" href="#" class="item  " tabindex="0">
                        <img class="img-responsive lazy" src="/template/web/assets/images/insta8.jpg" alt="Home 03">
                        <span class="instagram-info">
                                 <span class="social-wrap">
                                    <span class="social-info">1
                                        <i class="flaticon-chat"></i>
