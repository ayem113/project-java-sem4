								...
								<tbody>
                                    ...
                                    <td colspan="12" class="actions">
                                      ...
                                      <button type="submit" class="button btn btn-info btnClear" name="update_cart" value="Update cart" >Làm trống giỏ hàng
                                         ...
                                         <button type="submit" class="button btn btn-success btnAddCart" name="update_cart" value="Update cart" >Thanh toán ngay
                                        </button>
                                        <input type="hidden" id="furgan-cart-nonce" name="furgan-cart-nonce" value="f41b5bf554"><input type="hidden" name="_wp_http_referer" value="/furgan/cart/"></td>
                               		 </tr>
								</tbody>
							</table>
