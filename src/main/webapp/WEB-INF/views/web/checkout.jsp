                    ...
                    <div class="furgan">
                        ...
                        <div class="checkout-before-top">
                            ...
                            <div class="furgan-checkout-coupon">
                                ...
                                <form class="checkout_coupon furgan-form-coupon" method="post"
                                      style="display:none">
                        ...
                        <form name="checkout" method="post" class="checkout furgan-checkout"
                            ...
                            <div class="col2-set" id="customer_details">
                                <div class="col-1">
                                        ...
                                        <div class="furgan-billing-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-wide adchair-field validate-state"
                                               ...
                                               data-o_class="form-row form-row-wide adchair-field validate-state"><label
                                                    ...
                                                    class="optional">(optional)</span></label><span
                                                    class="furgan-input-wrapper"><input type="hidden"
                                                                                             class="hidden"
                                                                                             name="billing_state"
                                    ...
                                    <div class="furgan-account-fields">
                                        <p class="form-row form-row-wide create-account furgan-validated">
                                            <label class="furgan-form__label furgan-form__label-for-checkbox checkbox">
                                                <input class="furgan-form__input furgan-form__input-checkbox input-checkbox"
                            ...
                            <div id="order_review" class="furgan-checkout-review-order">
                                <table class="shop_table furgan-checkout-review-order-table">
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-total">
                                            <span class="furgan-Price-amount amount"><span
                                                    class="furgan-Price-currencySymbol">$</span>150.00</span></td>
                                    </tr>
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Alarm Clock&nbsp;&nbsp; <strong class="product-quantity">× 1</strong>
                                        </td>
                                        <td class="product-total">
                                            <span class="furgan-Price-amount amount"><span
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Chair AAC&nbsp;&nbsp; <strong class="product-quantity">×
                                            1</strong></td>
                                        <td class="product-total">
                                            <span class="furgan-Price-amount amount"><span
                                                    class="furgan-Price-currencySymbol">$</span>139.00</span></td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td><span class="furgan-Price-amount amount"><span
                                                class="furgan-Price-currencySymbol">$</span>418.00</span></td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td><strong><span class="furgan-Price-amount amount"><span
                                                class="furgan-Price-currencySymbol">$</span>418.00</span></strong>
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
